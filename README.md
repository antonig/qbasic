...
FILESEL26.BAS  A file selector Function based the FILES keyword of QB. Use cursor to change directory and select a file. Can filter the files displayed by extensions. Does'nt use DOS calls so a crippled COMMAND as the one in DosBox is not a problem.
